        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.php" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-primary">An-Najah Droms</h1>
                </a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>On this site, we do not only offer you student Dorms, but we offer you shops near you so that you can buy your needs from them. You can search for the type of property that you want to know more about by choosing the type of property here.</p>
                </div>
                <div class="row g-4">
