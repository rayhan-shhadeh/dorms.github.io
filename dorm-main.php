        ...
        <div class="container align-content-center align-items-center">
            ...
            <div class="row g-3 justify-content-center">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="position-relative">
                            <a class=" mx-1" href=""><img class="img-fluid" src="img/m5.jpg" style="height: 380px"  alt=""></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="position-relative">
                            <a class=" mx-1" href=""><img class="img-fluid" src="img/twin.jpg" alt=""></i></a>
                            <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden">
                        <div class="position-relative">
                            <a class=" mx-1" href=""><img class="img-fluid" src="img/d3.jpg" alt=""></i></a>
                            <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
